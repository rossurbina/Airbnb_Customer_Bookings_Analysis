...
load data local infile '/Users/rossurbina/Box Sync/Data Analytics Learning/Interview Test Prep Projects/Airbnb_sample_project/contacts.csv'
into table contacts
ignore 1 rows;

load data local infile '/Users/rossurbina/Box Sync/Data Analytics Learning/Interview Test Prep Projects/Airbnb_sample_project/searches.csv'
into table searches
ignore 1 rows;
...
# Make all 0000-00-00 values nul
...
SELECT COUNT(*) from guest_searches;

SELECT * FROM searches;
SELECT * FROM contacts;
SELECT * from guest_searches;
